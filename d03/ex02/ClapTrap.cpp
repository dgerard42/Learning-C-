...
ClapTrap::ClapTrap() : _hp(100), _max_hp(100), _level(1){
	int index = std::rand() % (4 - 0 + 1);
	std::string names[5] = {"Old Reginald", "Alice", "Vladislav", "Murt",
...
ClapTrap::ClapTrap(std::string const name) : _hp(100), _max_hp(100), _level(1),
											_name(name){
	std::cout << "an adorable new robot named " << this->_name << " was built"
		<< std::endl;
	return;
